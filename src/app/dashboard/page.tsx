    ...
    <div className="space-y-8 animate-fade-in">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground text-lg">
            Gusto Indian Bistro is humming beautifully this evening.
          </p>
        </div>
        <div className="flex gap-2">
          <Button
            variant="outline"
            className="shadow-sm border-primary/20 text-primary"
          >
            Live View
          </Button>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat, idx) => (
          <Card
            key={stat.title}
            className="group border-none shadow-sm hover:shadow-xl transition-all duration-300 animate-slide-up relative overflow-hidden"
          ...
          >
            ...
            <CardContent>
              ...
              <div className="flex items-center gap-2 mt-2">
                <Badge
                  variant="outline"
                  className={`px-1.5 py-0 border-none font-bold text-[10px] ${
                    stat.trend === 'up'
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
        <Card
          className="lg:col-span-4 border-none shadow-sm animate-slide-up bg-white/50 backdrop-blur-sm"
        ...
        >
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>
                Visualizing performance across service hours.
              </CardDescription>
            </div>
        ...
        <Card
          className="lg:col-span-3 border-none shadow-sm animate-slide-up"
        ...
        >
          <CardHeader>
            ...
            <CardDescription>
              Hot tickets currently in production.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-5">
              {[
                ...
                {
                  table: 'T-7',
                  items: 'Pani Puri (x3), Mango Lassi',
                  time: '4m',
                  status: 'Ready',
                  priority: 'Urgent',
                },
                ...
                <div
                  key={i}
                  className="flex items-center gap-4 p-3 rounded-2xl hover:bg-muted/50 transition-colors border border-transparent hover:border-border group"
                >
                  <div className="h-12 w-12 flex flex-col items-center justify-center bg-primary/5 rounded-2xl font-black text-primary border border-primary/10">
                    <span className="text-[10px] leading-none opacity-50 uppercase">
                      Tbl
                    </span>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {ticket.priority === 'High' && (
                        <Badge className="h-2 w-2 rounded-full p-0 bg-primary border-none shadow-glow" />
                      )}
                    </div>
            ...
            <div className="mt-6 pt-6 border-t flex items-center justify-between">
              ...
              <Button variant="link" className="text-xs text-primary font-bold">
                Manage Stations
              </Button>
            </div>
          </CardContent>
